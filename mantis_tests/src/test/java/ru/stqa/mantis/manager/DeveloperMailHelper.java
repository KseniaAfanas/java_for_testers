        ...
        while (System.currentTimeMillis()<start+duration.toMillis()){//пока тек время < (старт + Duration) выполняем действия
            ...
            try {
                ...
                if (response1.result().size()>0){
                    ...
                    var response2 = new ObjectMapper().readValue(text2, GetMessageResponse.class);//text - источник; AddUserResponse.class - тип данных
                    ...
                    return new String(MimeUtility.decode(
                            ...
                            "quoted-printable").readAllBytes()); //текст письма
                }
